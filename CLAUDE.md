...
**YOU ARE IN: `monorepo/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/monorepo/` (rig root) or other directories
...
**Your mail address:** `monorepo/polecats/obsidian`
**Your rig:** monorepo
**Your Witness:** `monorepo/witness`
...
| Ask Witness for help | `gt mail send monorepo/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`monorepo/witness`) when:
...
```bash
gt mail send monorepo/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
